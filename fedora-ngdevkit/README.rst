...
.. code-block:: bash
    ...
    podman pull docker.io/tprrt/fedora-ngdevkit
...
.. code-block:: bash
    ...
    podman build -t tprrt/fedora-ngdevkit:latest -f ./Dockerfile .
...
.. code-block:: bash
    ...
    podman container stop -t=1 tprrt/fedora-ngdevkit
    podman container rm tprrt/fedora-ngdevkit
    xhost -"local:podman@
