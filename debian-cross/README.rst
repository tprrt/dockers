...
.. code-block:: bash
    ...
    export export PATH=/aarch64--glibc--stable-2023.08-1/bin:$PATH
...
.. code-block:: bash
    ...
    export export PATH=/armv7-eabihf--glibc--stable-2023.08-1/bin:$PATH
    ...
    export export PATH=/riscv64-lp64d--glibc--stable-2023.08-1/bin:$PATH
